...
{
    public sealed class GetAllProductsQueryHandler : IRequestHandler<GetAllProductsQuery, IEnumerable<GetAllProductsQueryResponseModel>>
    {
        ...
        {
            var entities = this.productRepository.AllAsNoTracking().Select(x => new GetAllProductsQueryResponseModel()
            {
                Id = x.Id,
                Title = x.Title,
            });
